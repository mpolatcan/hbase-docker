.PHONY: publish-hbase
publish-hbase:
	sudo docker build -q -t mpolatcan/hbase:ubuntu-2.0.1-hadoop-3.1.1 --build-arg HBASE_VERSION="2.0.1" --build-arg HADOOP_VERSION="3.1.1" ./ubuntu/
	sudo docker push mpolatcan/hbase:ubuntu-2.0.1-hadoop-3.1.1
	sudo docker rmi mpolatcan/hbase:ubuntu-2.0.1-hadoop-3.1.1
	
	sudo docker build -q -t mpolatcan/hbase:alpine-2.0.1-hadoop-3.1.1 --build-arg HBASE_VERSION="2.0.1" --build-arg HADOOP_VERSION="3.1.1" ./alpine/
	sudo docker push mpolatcan/hbase:alpine-2.0.1-hadoop-3.1.1
	sudo docker rmi mpolatcan/hbase:alpine-2.0.1-hadoop-3.1.1
...
# ----------------------------------------------------------------------------------------------------------------------
	...
	sudo docker build -q -t mpolatcan/hbase:ubuntu-1.4.5-hadoop-3.1.1 --build-arg HBASE_VERSION="1.4.5" --build-arg HADOOP_VERSION="3.1.1" ./ubuntu/
	sudo docker push mpolatcan/hbase:ubuntu-1.4.5-hadoop-3.1.1
	sudo docker rmi mpolatcan/hbase:ubuntu-1.4.5-hadoop-3.1.1
	
	sudo docker build -q -t mpolatcan/hbase:alpine-1.4.5-hadoop-3.1.1 --build-arg HBASE_VERSION="1.4.5" --build-arg HADOOP_VERSION="3.1.1" ./alpine/
	sudo docker push mpolatcan/hbase:alpine-1.4.5-hadoop-3.1.1
	sudo docker rmi mpolatcan/hbase:alpine-1.4.5-hadoop-3.1.1
...
# ----------------------------------------------------------------------------------------------------------------------
	...
	sudo docker build -q -t mpolatcan/hbase:ubuntu-1.2.6.1-hadoop-3.1.1 --build-arg HBASE_VERSION="1.2.6.1" --build-arg HADOOP_VERSION="3.1.1" ./ubuntu/
	sudo docker push mpolatcan/hbase:ubuntu-1.2.6.1-hadoop-3.1.1
	sudo docker rmi mpolatcan/hbase:ubuntu-1.2.6.1-hadoop-3.1.1

	sudo docker build -q -t mpolatcan/hbase:alpine-1.2.6.1-hadoop-3.1.1 --build-arg HBASE_VERSION="1.2.6.1" --build-arg HADOOP_VERSION="3.1.1" ./alpine/
	sudo docker push mpolatcan/hbase:alpine-1.2.6.1-hadoop-3.1.1
	sudo docker rmi mpolatcan/hbase:alpine-1.2.6.1-hadoop-3.1.1
