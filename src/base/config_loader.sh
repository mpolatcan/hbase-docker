...
load_config "hbase.unsafe.stream.capability.enforce" "${HBASE_UNSAFE_STREAM_CAPABILITY_ENFORCE}" "hbase-site.xml"
...
load_config "phoenix.enabled" "${PHOENIX_ENABLED}" "hbase-site.xml"
...
load_config "phoenix.queryserver.http.port" "${PHOENIX_QUERYSERVER_HTTP_PORT}" "hbase-site.xml"
load_config "phoenix.queryserver.http.keytab.file" "${PHOENIX_QUERYSERVER_HTTP_KEYTAB_FILE}" "hbase-site.xml"
load_config "phoenix.queryserver.http.kerberos.principal" "${PHOENIX_QUERYSERVER_HTTP_KERBEROS_PRINCIPAL}" "hbase-site.xml"
load_config "phoenix.queryserver.metafactory.class" "${PHOENIX_QUERYSERVER_METAFACTORY_CLASS}" "hbase-site.xml"
load_config "phoenix.queryserver.serialization" "${PHOENIX_QUERYSERVER_SERIALIZATION}" "hbase-site.xml"
load_config "phoenix.queryserver.keytab.file" "${PHOENIX_QUERYSERVER_KEYTAB_FILE}" "hbase-site.xml"
load_config "phoenix.queryserver.kerberos.principal" "${PHOENIX_QUERYSERVER_KERBEROS_PRINCIPAL}" "hbase-site.xml"
load_config "phoenix.queryserver.kerberos.http.principal" "${PHOENIX_QUERYSERVER_KERBEROS_HTTP_PRINCIPAL}" "hbase-site.xml"
load_config "phoenix.queryserver.kerberos.allowed.realms" "${PHOENIX_QUERYSERVER_KERBEROS_ALLOWED_REALMS}" "hbase-site.xml"
load_config "phoenix.queryserver.dns.nameserver" "${PHOENIX_QUERYSERVER_DNS_NAMESERVER}" "hbase-site.xml"
load_config "phoenix.queryserver.dns.interface" "${PHOENIX_QUERYSERVER_DNS_INTERFACE}" "hbase-site.xml"
load_config "phoenix.queryserver.loadbalancer.enabled" "${PHOENIX_QUERYSERVER_LOADBALANCER_ENABLED}" "hbase-site.xml"
load_config "phoenix.queryserver.base.path" "${PHOENIX_QUERYSERVER_BASE_PATH}" "hbase-site.xml"
load_config "phoenix.queryserver.service.name" "${PHOENIX_QUERYSERVER_SERVICE_NAME}" "hbase-site.xml"
load_config "phoenix.queryserver.zookeeper.acl.username" "${PHOENIX_QUERYSERVER_ZOOKEEPER_ACL_USERNAME}" "hbase-site.xml"
load_config "phoenix.queryserver.zookeeper.acl.password" "${PHOENIX_QUERYSERVER_ZOOKEEPER_ACL_PASSWORD}" "hbase-site.xml"
