...
load_config "hbase.zookeeper.property.dataDir" "${HBASE_TMP_DIR}/zookeeper" "hbase-site.xml"
...
load_config "hbase.local.dir" "${HBASE_TMP_DIR}/local/" "hbase-site.xml"
...
load_config "hbase.regionserver.hostname" "${HBASE_REGIONSERVER_HOSTNAME}" "hbase-site.xml"
