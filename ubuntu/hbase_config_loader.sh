...
loadConfig "hbase.master.logcleaner.ttl" "${HBASE_MASTER_LOGCLEANER_TTL}" "hbase-site.xml"
loadConfig "hbase.master.procedurewalcleaner.ttl" "${HBASE_MASTER_PROCEDUREWALCLEANER_TTL}" "hbase-site.xml"
loadConfig "hbase.regionserver.logroll.period" "${HBASE_REGIONSERVER_LOGROLL_PERIOD}" "hbase-site.xml"
loadConfig "hbase.regionserver.region.split.policy" "${HBASE_REGIONSERVER_REGION_SPLIT_POLICY}" "hbase-site.xml"
loadConfig "hbase.regionserver.regionSplitLimit" "${HBASE_REGIONSERVER_REGION_SPLIT_LIMIT}" "hbase-site.xml"
